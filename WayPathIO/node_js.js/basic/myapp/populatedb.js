...
var Book = require('./models/buildings')
...
function buildingCreate(building_name, busy_level, current_time) {
  buildingdetail = {building_namee:building_name}
...
function createGenreBuildings(cb) {
    async.parallel([
        function(callback) {
          buildingCreate('Alkek', 5, Date(),);
        },
        function(callback) {
          buildingCreate('Comal', 4, Date(),);
        },
        function(callback) {
          buildingCreate('Derrick', 3, Date(),);
        },
        function(callback) {
          buildingCreate('Flowers', 2, Date(),);
        },
        function(callback) {
          buildingCreate('LBJ', 1, Date(),);
        },
        function(callback) {
          buildingCreate('UAC', 5, Date(),);
        },
        function(callback) {
          buildingCreate('Rec Center', 4, Date(),);
        },
        function(callback) {
          buildingCreate('Stadium', 5, Date(),);
        },
        ],
        // optional callback
        cb);
